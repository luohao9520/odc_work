...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("hot_reload", nargs="?", type=parse_bool, help="快捷开关：true 开启 Debug+热加载，false 关闭")
...
def resolve_run_config(argv: list[str] | None = None) -> dict:
    ...
    return {
        "host": args.host or os.environ.get("ATTENDANCE_HOST", "0.0.0.0"),
        "port": args.port if args.port is not None else int_env("ATTENDANCE_PORT", 5000),
        "debug": debug,
        "use_reloader": reload,
